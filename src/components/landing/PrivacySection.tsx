  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        {/* Pillars container with gradient border */}
        <div className={`gradient-border transition-all duration-1000 delay-200 ${
          ...
          <div className="p-8 md:p-10">
            ...
            <div className={`flex items-center justify-center gap-3 mb-10 flex-wrap transition-all duration-700 delay-500 ${
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-300 text-sm font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              {PILLARS.map((pillar, i) => (
                ...
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/10 mb-5">
