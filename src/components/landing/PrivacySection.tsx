        ...
        <div className={`gradient-border transition-all duration-1000 delay-200 ${
          ...
          <div className="p-8 md:p-10">
            ...
            <div className={`flex items-center justify-center gap-3 mb-10 flex-wrap transition-all duration-700 delay-500 ${
              ...
              <div className="flex items-center gap-2 px-4 py-2 glass-card text-emerald-300 text-sm font-medium">
              ...
              <div className="flex items-center gap-2 px-4 py-2 glass-card text-blue-300 text-sm font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              {PILLARS.map((pillar, i) => (
                ...
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 glass-card mb-5">
